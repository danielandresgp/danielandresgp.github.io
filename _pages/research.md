...
<div>
   ...
   <p style="text-align: center"><font size="2"><b>Figure 2:</b> For a space $\Omega = \{\omega_1, \omega_2\}$ with two states, the LHS depicts the different values of the Kullback-Leibler divergence between two probability measures $\mathbf P$ and $\mathbf P_0$:
   \begin{equation*}
