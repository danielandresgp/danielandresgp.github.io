...
<div>
   ...
   \begin{equation*}
      ...
      \end{equation*}
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Observe that the KL divergence is only zero when $\mathbf P = \mathbf P_0$; anywhere else, it is positive. On the same space, the RHS depicts the different values of the total <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; active information, defined as 
      \begin{equation*}
