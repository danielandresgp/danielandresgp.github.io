...
### Stable allocations
   ...
   <p align="justify"> More formally, assume there is a Poisson point $Z \subset \mathbb R^d$ of intensity $\lambda$. Assume that every point $\zeta \in Z$ desires
for itself a territory of $\mathbb R^d$ of (constant or random volume $V$, which is as close to $\zeta$ as possible.</p>
