...
## Stable allocations
   ...
   <p align="justify"><font size="2"> The image shows a simulation (performed by chatgpt) of a stable allocation to a Poisson process of intensity 1 where each center wants to colonize a territory whose expected volume is 1.</font></p>
